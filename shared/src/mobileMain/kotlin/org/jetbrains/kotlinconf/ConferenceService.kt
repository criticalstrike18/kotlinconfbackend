...
import org.jetbrains.kotlinconf.Database.DriverFactory
...
class ConferenceService(
    ...
    private val _podcastChannels = MutableStateFlow<List<PodcastChannels>>(emptyList())
    val podcastChannels: StateFlow<List<PodcastChannels>> = _podcastChannels.asStateFlow()
    ...
    /**
     * Convenience helper for episodes.
     * When you navigate to the episodes screen, you can call this function to obtain a StateFlow
     * for the episodes of a given channel.
     */
    fun episodesForChannel(channelId: Long): StateFlow<List<PodcastEpisodes>> {
        // Convert the Flow from SQLDelight into a StateFlow.
        return dbStorage.getEpisodesForChannelFlow(channelId)
            .stateIn(this, SharingStarted.Eagerly, emptyList())
    }
